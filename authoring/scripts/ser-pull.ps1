...
try {
  ...
  Write-Host "Pulling serialized items from CM into authoring/items/nextjs-starter ..." -ForegroundColor Green
  dotnet sitecore ser pull -i nextjs-starter

  Write-Host "Done. Review changes under authoring/items/nextjs-starter before committing." -ForegroundColor Green
}
finally {
  Pop-Location
}
